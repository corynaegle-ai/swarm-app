...
async function createPullRequest(ticket, branchName, summary, criteriaStatus) {
  ...
  // Ensure head is fully qualified for GitHub API (owner:branch)
  // This is required when working with forks or to be explicit
  const headRef = `${owner}:${branchName}`;

  log.info('Creating PR', { owner, repo, head: headRef, base: 'main' });
