 ...
 */
export async function notifyTicketStateChange(ticketId, state, extra = {}) {
  try {
 ...
 */
export async function notifyTicketProgress(ticketId, phase, message, extra = {}) {
  try {
 ...
 */
export async function notifyPRCreated(ticketId, prUrl, extra = {}) {
  try {
    await fetch(`${PLATFORM_URL}/api/internal/ticket-event`, {
      method: 'POST',
      headers: {
 ...
 */
export async function notifyBuildProgress(sessionId, percent, message, extra = {}) {
  try {
